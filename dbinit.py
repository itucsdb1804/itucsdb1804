...
INIT_STATEMENTS = [
    ...
    #"CREATE TABLE STORE (STORE_ID SERIAL PRIMARY KEY, NAME VARCHAR(40) NOT NULL, PHONE VARCHAR(15) NOT NULL, ADRESS_ID INTEGER REFERENCES ADDRESS (ADDRESS_ID), EMAIL VARCHAR(50) UNIQUE NOT NULL, WEBSITE VARCHAR(50) UNIQUE NOT NULL, OPENEDDATE DATE NOT NULL, EXPLANATION VARCHAR(200) NOT NULL)",
    "CREATE TABLE STORE (STORE_ID SERIAL PRIMARY KEY, NAME VARCHAR(40) NOT NULL, PHONE VARCHAR(15) NOT NULL, ADRESS_ID INTEGER NOT NULL, EMAIL VARCHAR(50) NOT NULL, WEBSITE VARCHAR(50) NOT NULL, OPENEDDATE DATE NOT NULL, EXPLANATION VARCHAR(200) NOT NULL)",
    # Change two store queries after create CUSTOMER table
    #"CREATE TABLE COMMENT (COMMENT_ID SERIAL PRIMARY KEY, CUSTOMER_ID INTEGER REFERENCES CUSTOMER (CUSTOMER_ID), TITLE VARCHAR(30) NOT NULL, EXPLANATION VARCHAR(200) NOT NULL, UPDATETIME DATETIME NOT NULL, POINTTOBOOK INTEGER NOT NULL)",
    "CREATE TABLE COMMENT (COMMENT_ID SERIAL PRIMARY KEY, CUSTOMER_ID INTEGER NOT NULL, TITLE VARCHAR(30) NOT NULL, EXPLANATION VARCHAR(200) NOT NULL, UPDATETIME TIMESTAMP NOT NULL, POINTTOBOOK INTEGER NOT NULL)",
]
