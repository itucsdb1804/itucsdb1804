...
INIT_STATEMENTS = [
    ...
    "CREATE TABLE BOOK (BOOK_ID SERIAL PRIMARY KEY, NAME VARCHAR(40) NOT NULL, WRITINGDATE DATE NOT NULL, TYPE VARCHAR(40) NOT NULL, ISBN VARCHAR(20) NOT NULL, NUMBEROFPAGES INTEGER NOT NULL, PUBLISHER VARCHAR(40) NOT NULL)",
    "CREATE TABLE STORE (STORE_ID SERIAL PRIMARY KEY, NAME VARCHAR(40) NOT NULL, PHONE INTEGER UNIQUE NOT NULL, ADRESS_ID INTEGER REFERENCES ADDRESS (ADDRESS_ID), EMAIL VARCHAR(50) UNIQUE NOT NULL, OPENEDDATE DATE NOT NULL, EXPLANATION VARCHAR(200) NOT NULL)",
