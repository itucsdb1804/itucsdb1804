    ...
    def get_row(self, transaction_id, store_id, book_id, edition_number):
        ...
        with dbapi2.connect(self.url) as connection:
            ...
            if transaction_product is not None:
                _transaction_product = TransactionProductObj(transaction_product[0], transaction_product[1], transaction_product[2], transaction_product[3], transaction_product[4], transaction_product[5])
    ...
    def get_table(self):
        ...
        with dbapi2.connect(self.url) as connection:
            ...
            for transaction_product in cursor:
                transaction_product_ = TransactionProductObj(transaction_product[0], transaction_product[1], transaction_product[2], transaction_product[3], transaction_product[4], transaction_product[5])
